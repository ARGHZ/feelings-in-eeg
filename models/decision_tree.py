...
y, X = np.array([emotions.index(value) for index, value in data[head_it_config.CLASSIFICATION_VARS[0]].items()]), \
       data[head_it_config.CLASSIFICATION_VARS[1:]].to_numpy()
y[y <= 7] = 0
y[y > 7] = 1
...
plot_tree(estimator, feature_names=head_it_config.CLASSIFICATION_VARS[1:], class_names=['positive', 'negative'], filled=True)
